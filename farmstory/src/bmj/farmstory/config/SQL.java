...
public class SQL {
	...
	public static final String SELECT_LIST_INDEX = "SELECT seq, cate, title, SUBSTRING(rdate, 3, 8) as rdate FROM `JSP_BOARD` WHERE parent=0 AND cate=? LIMIT 5";
